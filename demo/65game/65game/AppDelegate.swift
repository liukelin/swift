...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /**
    // #pragma mark - Core Data Helper 开始 CoreData
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //set
        //NSUserDefaults.standardUserDefaults().setObject("abc", forKey: "key");
        
        
    //get
    print(NSUserDefaults.standardUserDefaults().objectForKey("key"))
